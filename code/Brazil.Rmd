...
Brazil_pre_uncleaned$DJF[is.na(Brazil_pre_uncleaned$DJF)] <- mean(Brazil_pre_uncleaned$DJF, na.rm = TRUE)
colSums(is.na(Brazil_pre_uncleaned))

write.csv(Brazil_pre_uncleaned, "../data/processed_brazil_precipitation.csv", row.names = FALSE)
